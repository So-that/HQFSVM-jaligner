...
public class LibSVM 
  ...
  public static final int KERNELTYPE_PRECOMPUTED = 4;
  ...
  public static final Tag[] TAGS_KERNELTYPE = {
          ...
          new Tag(KERNELTYPE_PRECOMPUTED, "jaligner"),
  };

  /**
   * the kernel type.
   */
  protected int m_KernelType = KERNELTYPE_PRECOMPUTED;
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() != 0)
      ...
      setKernelType(
              new SelectedTag(KERNELTYPE_PRECOMPUTED, TAGS_KERNELTYPE));
  ...
  public String getRevision() {
    return RevisionUtils.extract("$Revision: 13288 $");
  }
